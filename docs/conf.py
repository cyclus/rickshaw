...
RICKSHAW_VERSION = rickshaw.__version__
...
project = u'rickshaw'
copyright = u'2016-2017, ERGS (Anthony Scopatz et al.)'
...
version = RICKSHAW_VERSION.rsplit('.', 1)[0]

# The full version, including alpha/beta/rc tags.
release = RICKSHAW_VERSION
...
modindex_common_prefix = ['rickshaw.']
...
if not on_rtd:
    ...
    html_theme_options = {
        'max_width': '1250px',
        'minimal_width': '700px',
        'relbarbgcolor': '#8f4b32',
        'footerbgcolor': '#b0aeaf',
        'sidebarwidth': '300px',
        'sidebarbgcolor': '#d5935e',
...
# of the sidebar.
html_logo = '_static/rickshaw.svg'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/rickshaw_128px.ico'
